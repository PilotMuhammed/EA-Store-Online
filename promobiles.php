...
<body>
	...
	<!-- apple mobile start -->
		...
		<h1 class="heading"> Apple <span>Mobile</span> </h1>
			<td>
				<form>
					<div class = "products">
						<div class = "container">
			    			<div class="product-items">
			    				<?php
									...
									$query1="select *, categories_name, company from products where categories_name = 'mobile' and company = 'apple' ";
	...
	<!-- asus mobile start -->
		...
		<!-- <h1 class="heading"> Asus <span>Mobile</span> </h1> -->
			<td>
				<form>
					<div class = "products">
						<div class = "container">
			    			<div class="product-items">
			    				<?php
									include("connection.php");
									$query1="select *, categories_name, company from products where categories_name = 'mobile' and company = 'asus' ";
									$pquery=mysqli_query($conn,$query1);
									$i=1;
									echo "<table>";
								?>
	...
	<!-- samsung mobile start -->
		...
		<h1 class="heading"> Samsung <span>Mobile</span> </h1>
			<td>
				<form>
					<div class = "products">
						<div class = "container">
			    			<div class="product-items">
			    				<?php
									include("connection.php");
									$query1="select *, categories_name, company from products where categories_name = 'mobile' and company = 'samsung' ";
									$pquery=mysqli_query($conn,$query1);
									$i=1;
									echo "<table>";
								?>
	...
	<!-- redmi mobile start -->
		...
		<h1 class="heading"> Redmi <span>Mobile</span> </h1>
			<td>
				<form>
					<div class = "products">
						<div class = "container">
			    			<div class="product-items">
			    				<?php
									include("connection.php");
									$query1="select *, categories_name, company from products where categories_name = 'mobile' and company = 'redmi' ";
									$pquery=mysqli_query($conn,$query1);
									$i=1;
									echo "<table>";
								?>
