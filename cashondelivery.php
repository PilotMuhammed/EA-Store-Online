...
if(isset($_POST['bill'])){
   ...
   $bill_query = mysqli_query($conn, "INSERT INTO `bill`(fullname, email, mobile_no, payment_type, address, city, state, pincode, total_product, total_amount) VALUES('$fullname','$email','$mobileno','$method','$address','$city','$state','$pincode','$total_product','$price_total')") or die('query failed');
        ...
        <h1 class="form-title">Bill Payment</h1>
            ...
            <div class="main-user-info">
             ...
             <div class="user-input-box">
                ...
                <input type="text" name="city" class="city" placeholder="Enter your City name" required />
              </div>

              <div class="user-input-box">
                <label for="">State:</label>
                <input type="text" name="state" class="state" placeholder="Enter your State name " required />
              </div>
              ...
              <div class="form-submit-btn">
                ...
                <input href="cashondelivery.php?delete_all" type="submit" name="bill" value="Checkout" onclick="return formValidation()">
              </div>
